...
func (e *StatementMul) SetStatus(status int) {
	e.iconStatus = status
}

func (e *StatementMul) GetStatus() (staus int) {
	return e.iconStatus
}

func (e *StatementMul) GetIcon() (register *manager.RegisterIcon) {
...
func (e *StatementMul) getIcon(data rulesIcon.Data) (png js.Value) {
...
func (e *StatementMul) GetWarning() (warning bool) {
	return e.block.GetWarning()
}

func (e *StatementMul) GetDragBlocked() (blocked bool) {
	return e.block.GetDragLocked()
}

func (e *StatementMul) GetDragEnable() (enabled bool) {
	return e.block.GetDragEnable()
}

func (e *StatementMul) GetResize() (enabled bool) {
	return e.block.GetResizeEnable()
}

func (e *StatementMul) GetResizeBlocked() (blocked bool) {
	return e.block.GetResizeLocked()
}

func (e *StatementMul) GetSelectBlocked() (blocked bool) {
	return e.block.GetSelectLocked()
}

func (e *StatementMul) GetSelected() (selected bool) {
...
func (e *StatementMul) GetName() (name string) {
...
func (e *StatementMul) GetX() (x rulesDensity.Density) {
	return e.block.GetX()
}

func (e *StatementMul) GetY() (y rulesDensity.Density) {
	return e.block.GetY()
}

func (e *StatementMul) SetX(x rulesDensity.Density) {
	e.block.SetX(x)
}

func (e *StatementMul) SetY(y rulesDensity.Density) {
	e.block.SetY(y)
}

func (e *StatementMul) SetWidth(width rulesDensity.Density) {
	e.block.SetWidth(width)
}

func (e *StatementMul) SetHeight(height rulesDensity.Density) {
...
func (e *StatementMul) GetZIndex() (zIndex int) {
