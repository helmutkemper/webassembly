...
func main() {
	...
	manager.Manager.Register(stmLoop.GetIcon())
	...
	manager.Manager.Register(stmAdd.GetIcon())
	...
	manager.Manager.Register(stmSub.GetIcon())
	...
	manager.Manager.Register(stmDiv.GetIcon())
	...
	manager.Manager.Register(stmMul.GetIcon())
