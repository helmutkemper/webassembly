...
func (e *TagSvgMask) GetXY() (x, y float64) {
	x = e.GetX()
	y = e.GetY()
...
func (e *TagSvgMask) GetX() (x float64) {
...
func (e *TagSvgMask) GetY() (y float64) {
	if e.selfElement.IsUndefined() || e.selfElement.IsNull() {
		return
	}
...
//       }
//     }()
func (e *TagSvgMask) AddListenerClick(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"click",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerMouseOver(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"mouseover",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerMouseOut(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"mouseout",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerMouseMove(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"mousemove",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerMouseLeave(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"mouseleave",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerMouseEnter(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"mouseenter",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerMouseDown(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"mousedown",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerMouseUp(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"mouseup",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerMouseWheel(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"mousewheel",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerDoubleClick(mouseEvet *chan mouse.Data) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"dblclick",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerFocusIn(focusEvent *chan struct{}) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"focusin",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMask) AddListenerFocusOut(focusEvent *chan struct{}) (ref *TagSvgMask) {
	e.selfElement.Call(
		"addEventListener",
		"animationiteration",
		js.FuncOf(
