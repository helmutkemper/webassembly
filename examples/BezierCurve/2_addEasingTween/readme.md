...
This example shows how to use the Bézier curve and easing tween.

### Português:

Este exemplo mostra como usar a curva de Bézier e easing tween.
...
[https://localhost/examples/BezierCurve/2_addEasingTween/](https://localhost/examples/BezierCurve/2_addEasingTween/)
