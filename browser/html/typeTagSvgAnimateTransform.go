...
func (e *TagSvgAnimateTransform) Accumulate(accumulate SvgAccumulate) (ref *TagSvgAnimateTransform) {
...
// valores absolutos.
func (e *TagSvgAnimateTransform) Additive(additive SvgAdditive) (ref *TagSvgAnimateTransform) {
...
func (e *TagSvgAnimateTransform) CalcMode(calcMode SvgCalcMode) (ref *TagSvgAnimateTransform) {
