...
func (e *TagSvgMask) CreateElement(tag Tag) (ref *TagSvgMask) {
...
//      mais informações.
func (e *TagSvgMask) Display(display SvgDisplay) (ref *TagSvgMask) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgMask) FillOpacity(fillOpacity float64) (ref *TagSvgMask) {
...
func (e *TagSvgMask) FontSize(fontSize float64) (ref *TagSvgMask) {
...
func (e *TagSvgMask) FontVariant(fontVariant FontVariantRule) (ref *TagSvgMask) {
...
func (e *TagSvgMask) FontWeight(fontWeight FontWeightRule) (ref *TagSvgMask) {
