...
// Português:
//
//  Uma lista de URLs separados por espaços. Quando o link for seguido, o navegador enviará solicitações POST com o corpo PING para as URLs. Normalmente para rastreamento.
