...
func (e *TagSvgA) D(d *SvgPath) (ref *TagSvgA) {
...
//      mais informações.
func (e *TagSvgA) Display(display SvgDisplay) (ref *TagSvgA) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgA) FillOpacity(fillOpacity float64) (ref *TagSvgA) {
...
func (e *TagSvgA) FontSize(fontSize float64) (ref *TagSvgA) {
...
func (e *TagSvgA) FontVariant(fontVariant FontVariantRule) (ref *TagSvgA) {
...
func (e *TagSvgA) FontWeight(fontWeight FontWeightRule) (ref *TagSvgA) {
