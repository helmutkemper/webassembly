...
This example shows how to arc on cavas element.

### Português:

Este exemplo mostra como arco no elemnto canvas.
...
[https://localhost/examples/canvas/arc/](https://localhost/examples/canvas/arc/)
