...
//      mais informações.
func (e *TagSvgMarker) Display(display SvgDisplay) (ref *TagSvgMarker) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgMarker) FillOpacity(fillOpacity float64) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) FontSize(fontSize float64) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) FontVariant(fontVariant FontVariantRule) (ref *TagSvgMarker) {
...
func (e *TagSvgMarker) FontWeight(fontWeight FontWeightRule) (ref *TagSvgMarker) {
