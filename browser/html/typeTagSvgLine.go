...
func (e *TagSvgLine) Init(id string) (ref *TagSvgLine) {
...
func (e *TagSvgLine) CreateElement(tag Tag) (ref *TagSvgLine) {
...
//      mais informações.
func (e *TagSvgLine) Display(display SvgDisplay) (ref *TagSvgLine) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgLine) FillOpacity(fillOpacity float64) (ref *TagSvgLine) {
...
func (e *TagSvgLine) FontSize(fontSize float64) (ref *TagSvgLine) {
...
func (e *TagSvgLine) FontVariant(fontVariant FontVariantRule) (ref *TagSvgLine) {
...
func (e *TagSvgLine) FontWeight(fontWeight FontWeightRule) (ref *TagSvgLine) {
