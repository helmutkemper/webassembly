...
//      mais informações.
func (e *TagSvgFilter) Display(display SvgDisplay) (ref *TagSvgFilter) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgFilter) FillOpacity(fillOpacity float64) (ref *TagSvgFilter) {
...
func (e *TagSvgFilter) FontSize(fontSize float64) (ref *TagSvgFilter) {
...
func (e *TagSvgFilter) FontVariant(fontVariant FontVariantRule) (ref *TagSvgFilter) {
...
func (e *TagSvgFilter) FontWeight(fontWeight FontWeightRule) (ref *TagSvgFilter) {
