...
func (e *TagSvgSymbol) Init(id string) (ref *TagSvgSymbol) {
...
//      mais informações.
func (e *TagSvgSymbol) Display(display SvgDisplay) (ref *TagSvgSymbol) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgSymbol) FillOpacity(fillOpacity float64) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) FontSize(fontSize float64) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) FontVariant(fontVariant FontVariantRule) (ref *TagSvgSymbol) {
...
func (e *TagSvgSymbol) FontWeight(fontWeight FontWeightRule) (ref *TagSvgSymbol) {
