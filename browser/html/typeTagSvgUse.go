...
func (e *TagSvgUse) Init(id string) (ref *TagSvgUse) {
...
//      mais informações.
func (e *TagSvgUse) Display(display SvgDisplay) (ref *TagSvgUse) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgUse) FillOpacity(fillOpacity float64) (ref *TagSvgUse) {
...
func (e *TagSvgUse) FontSize(fontSize float64) (ref *TagSvgUse) {
...
func (e *TagSvgUse) FontVariant(fontVariant FontVariantRule) (ref *TagSvgUse) {
...
func (e *TagSvgUse) FontWeight(fontWeight FontWeightRule) (ref *TagSvgUse) {
