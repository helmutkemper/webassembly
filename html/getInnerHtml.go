...
//  within the element.
//
// To insert the HTML into the document rather than replace the contents of an element, use the
...
// SyntaxError DOMException
//
// Lançado se foi feita uma tentativa de definir o valor de innerHTML usando uma string que não é HTML
...
func (e *GlobalAttributes) GetInnerHtml() (html string) {
	return e.selfElement.Get("innerHTML").String()
}
