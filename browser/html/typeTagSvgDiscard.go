...
func (e *TagSvgDiscard) D(d *SvgPath) (ref *TagSvgDiscard) {
...
//      mais informações.
func (e *TagSvgDiscard) Display(display SvgDisplay) (ref *TagSvgDiscard) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgDiscard) FillOpacity(fillOpacity float64) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) FontSize(fontSize float64) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) FontVariant(fontVariant FontVariantRule) (ref *TagSvgDiscard) {
...
func (e *TagSvgDiscard) FontWeight(fontWeight FontWeightRule) (ref *TagSvgDiscard) {
