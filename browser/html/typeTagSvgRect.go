...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgRect) FillOpacity(fillOpacity float64) (ref *TagSvgRect) {
...
func (e *TagSvgRect) FontSize(fontSize float64) (ref *TagSvgRect) {
...
func (e *TagSvgRect) FontVariant(fontVariant FontVariantRule) (ref *TagSvgRect) {
...
func (e *TagSvgRect) FontWeight(fontWeight FontWeightRule) (ref *TagSvgRect) {
