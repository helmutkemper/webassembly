...
func (e *TagSvgTextPath) Init(id string) (ref *TagSvgTextPath) {
...
//      mais informações.
func (e *TagSvgTextPath) Display(display SvgDisplay) (ref *TagSvgTextPath) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgTextPath) FillOpacity(fillOpacity float64) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) FontSize(fontSize float64) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) FontVariant(fontVariant FontVariantRule) (ref *TagSvgTextPath) {
...
func (e *TagSvgTextPath) FontWeight(fontWeight FontWeightRule) (ref *TagSvgTextPath) {
