...
func (e *TagInputNumber) ListenerRemove(event generic.EventName) (ref *TagInputNumber) {
...
func (e *TagInputNumber) callFunc(funcObj reflect.Value, params ...interface{}) (results []interface{}, err error) {
...
func (e *TagInputNumber) isBoolean(str string) (boolean bool) {
...
func (e *TagInputNumber) isNumeric(str string) (numeric bool) {
	for k := range str {
		switch str[k] {
		case '.':
			continue
...
func (e *TagInputNumber) ListenerAdd(event string, params []interface{}, functions []reflect.Value) (ref *TagInputNumber) {
...
func (e *TagInputNumber) ListenerAdd2(event string, funcObj reflect.Value, params ...interface{}) (ref *TagInputNumber) {
	...
	e.listener[event] = js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		...
		element := reflect.ValueOf(params[0])
		element1 := reflect.ValueOf(params[1])
		...
		_, err := e.callFunc(funcObj, element.Interface())
		if err != nil {
			log.Printf("error: chamar a função %v, retornou um erro: %v", funcObj.Type().Name(), err)
			return nil
		}
...
//func (e *TagInputNumber) ListenerAdd(event generic.EventName, dataType any, function func(arg any)) (ref *TagInputNumber) {
//
//	if function == nil {
...
//
//		if !element.IsValid() {
//			log.Printf(">>>>>>>> error: o evento não consegue popular a variável de evento.")
//			log.Printf("isto geralmente ocorre quando:")
//			log.Printf("  você não passa um ponteiro para o endereço de memória onde a variável se encontra;")
//			log.Printf("  o campo não é público, a primeira letra do campo dentro do struct é minúscula.")
//			return nil
//		}
//		for i := 0; i != element.NumField(); i += 1 {
//			fieldVal := element.Field(i)
...
//
//			if !fieldVal.CanSet() {
//				log.Printf("error: o evento não consegue popular o campo '%v' da variável de evento.", propertyToGet)
//				log.Printf("isto geralmente ocorre quando:")
//				log.Printf("  o campo não é público, a primeira letra do campo dentro do struct é minúscula.")
//				continue
//			}
