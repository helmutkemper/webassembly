...
This example shows how to change the operation of a range component, inverting the numeric values shown in the input 
range and number

### Português:

Este exemplo mostra como alterar o funcionamento de um componente do tipo range, invertendo os valores numéricos 
mostrados no input range e number
...
[https://localhost/examples/controlPanelRangeComplex/](https://localhost/examples/controlPanelRangeComplex/)
...
func (e *OnChangeEvent) OnChange(_ OnChangeEvent, reference DraggingEffect) {
