...
//      mais informações.
func (e *TagSvgSwitch) Display(display SvgDisplay) (ref *TagSvgSwitch) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgSwitch) FillOpacity(fillOpacity float64) (ref *TagSvgSwitch) {
...
func (e *TagSvgSwitch) FontWeight(fontWeight FontWeightRule) (ref *TagSvgSwitch) {
