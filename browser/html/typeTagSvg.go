...
func (e *TagSvg) D(d *SvgPath) (ref *TagSvg) {
...
//      mais informações.
func (e *TagSvg) Display(display SvgDisplay) (ref *TagSvg) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvg) FillOpacity(fillOpacity float64) (ref *TagSvg) {
...
func (e *TagSvg) FontSize(fontSize float64) (ref *TagSvg) {
...
func (e *TagSvg) FontVariant(fontVariant FontVariantRule) (ref *TagSvg) {
...
func (e *TagSvg) FontWeight(fontWeight FontWeightRule) (ref *TagSvg) {
