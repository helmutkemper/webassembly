...
func (e *TagSvgCircle) CreateElement(tag Tag) (ref *TagSvgCircle) {
...
//      mais informações.
func (e *TagSvgCircle) Display(display SvgDisplay) (ref *TagSvgCircle) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgCircle) FillOpacity(fillOpacity float64) (ref *TagSvgCircle) {
...
func (e *TagSvgCircle) FontSize(fontSize float64) (ref *TagSvgCircle) {
...
func (e *TagSvgCircle) FontVariant(fontVariant FontVariantRule) (ref *TagSvgCircle) {
...
func (e *TagSvgCircle) FontWeight(fontWeight FontWeightRule) (ref *TagSvgCircle) {
