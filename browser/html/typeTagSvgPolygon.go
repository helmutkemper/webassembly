...
//      mais informações.
func (e *TagSvgPolygon) Display(display SvgDisplay) (ref *TagSvgPolygon) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgPolygon) FillOpacity(fillOpacity float64) (ref *TagSvgPolygon) {
...
func (e *TagSvgPolygon) FontSize(fontSize float64) (ref *TagSvgPolygon) {
...
func (e *TagSvgPolygon) FontVariant(fontVariant FontVariantRule) (ref *TagSvgPolygon) {
...
func (e *TagSvgPolygon) FontWeight(fontWeight FontWeightRule) (ref *TagSvgPolygon) {
