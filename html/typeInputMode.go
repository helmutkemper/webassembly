...
const (
	...
	// Português:
	//
	//  Teclado de entrada numérica fracionária contendo os dígitos e o separador decimal para a localidade do usuário (normalmente . ou ,). Os dispositivos podem ou não mostrar uma tecla de menos (-).
	...
	// Português:
	//
	//  Teclado de entrada numérica, mas requer apenas os dígitos de 0 a 9. Os dispositivos podem ou não mostrar uma tecla de menos.
	...
	// Português:
	//
	//  Uma entrada do teclado do telefone, incluindo os dígitos de 0 a 9, o asterisco (*) e a tecla sustenido (#). As entradas que exigem um número de telefone normalmente devem usar <input type="tel">.
	...
	// Português:
	//
	//  Um teclado virtual otimizado para entrada de pesquisa. Por exemplo, a chave returnsubmit pode ser rotulada como "Search", juntamente com possíveis outras otimizações. As entradas que exigem uma consulta de pesquisa normalmente devem usar <input type="search">.
	...
	// Português:
	//
	//  Um teclado virtual otimizado para inserir endereços de e-mail. Normalmente inclui o @character, bem como outras otimizações. As entradas que exigem endereços de e-mail normalmente devem usar <input type="email">.
	...
	// Português:
	//
	//  Um teclado otimizado para inserir URLs. Isso pode ter a chave mais proeminente, por exemplo. Recursos aprimorados podem incluir acesso ao histórico e assim por diante. As entradas que exigem um URL normalmente devem usar <input type="url">.
