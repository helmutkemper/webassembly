...
func (e *TagSvgFeDiffuseLighting) CreateElement(tag Tag) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) Cursor(cursor SvgCursor) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) D(d *SvgPath) (ref *TagSvgFeDiffuseLighting) {
...
//      mais informações.
func (e *TagSvgFeDiffuseLighting) Display(display SvgDisplay) (ref *TagSvgFeDiffuseLighting) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgFeDiffuseLighting) FillOpacity(fillOpacity float64) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) FontSize(fontSize float64) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) FontVariant(fontVariant FontVariantRule) (ref *TagSvgFeDiffuseLighting) {
...
func (e *TagSvgFeDiffuseLighting) FontWeight(fontWeight FontWeightRule) (ref *TagSvgFeDiffuseLighting) {
