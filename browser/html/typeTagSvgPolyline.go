...
//      mais informações.
func (e *TagSvgPolyline) Display(display SvgDisplay) (ref *TagSvgPolyline) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgPolyline) FillOpacity(fillOpacity float64) (ref *TagSvgPolyline) {
...
func (e *TagSvgPolyline) FontSize(fontSize float64) (ref *TagSvgPolyline) {
...
func (e *TagSvgPolyline) FontVariant(fontVariant FontVariantRule) (ref *TagSvgPolyline) {
...
func (e *TagSvgPolyline) FontWeight(fontWeight FontWeightRule) (ref *TagSvgPolyline) {
