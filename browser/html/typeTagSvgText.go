...
//      mais informações.
func (e *TagSvgText) Display(display SvgDisplay) (ref *TagSvgText) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgText) FillOpacity(fillOpacity float64) (ref *TagSvgText) {
...
func (e *TagSvgText) FontSize(fontSize float64) (ref *TagSvgText) {
...
func (e *TagSvgText) FontVariant(fontVariant FontVariantRule) (ref *TagSvgText) {
...
func (e *TagSvgText) FontWeight(fontWeight FontWeightRule) (ref *TagSvgText) {
...
func (e *TagSvgText) Dx(dx string) (ref *TagSvgText) {
...
func (e *TagSvgText) Dy(dy string) (ref *TagSvgText) {
