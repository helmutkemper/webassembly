...
func (e *TagSvgStop) Init(id string) (ref *TagSvgStop) {
...
//      mais informações.
func (e *TagSvgStop) Display(display SvgDisplay) (ref *TagSvgStop) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgStop) FillOpacity(fillOpacity float64) (ref *TagSvgStop) {
...
func (e *TagSvgStop) FontSize(fontSize float64) (ref *TagSvgStop) {
...
func (e *TagSvgStop) FontVariant(fontVariant FontVariantRule) (ref *TagSvgStop) {
...
func (e *TagSvgStop) FontWeight(fontWeight FontWeightRule) (ref *TagSvgStop) {
