...
//      mais informações.
func (e *TagSvgImage) Display(display SvgDisplay) (ref *TagSvgImage) {
...
//   Notes:
//     *As a presentation attribute fill-opacity can be used as a CSS property.
func (e *TagSvgImage) FillOpacity(fillOpacity float64) (ref *TagSvgImage) {
...
func (e *TagSvgImage) FontSize(fontSize float64) (ref *TagSvgImage) {
...
func (e *TagSvgImage) FontVariant(fontVariant FontVariantRule) (ref *TagSvgImage) {
...
func (e *TagSvgImage) FontWeight(fontWeight FontWeightRule) (ref *TagSvgImage) {
