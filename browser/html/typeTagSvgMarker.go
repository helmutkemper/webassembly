...
func (e *TagSvgMarker) GetXY() (x, y float64) {
	x = e.GetX()
	y = e.GetY()
...
func (e *TagSvgMarker) GetX() (x float64) {
...
func (e *TagSvgMarker) GetY() (y float64) {
	if e.selfElement.IsUndefined() || e.selfElement.IsNull() {
		return
	}
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerClick(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"click",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerMouseOver(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"mouseover",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerMouseOut(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"mouseout",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerMouseMove(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"mousemove",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerMouseLeave(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"mouseleave",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerMouseEnter(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"mouseenter",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerMouseDown(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"mousedown",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerMouseUp(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"mouseup",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerMouseWheel(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"mousewheel",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerDoubleClick(mouseEvet *chan mouse.Data) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"dblclick",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerFocusIn(focusEvent *chan struct{}) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"focusin",
		js.FuncOf(
...
//       }
//     }()
func (e *TagSvgMarker) AddListenerFocusOut(focusEvent *chan struct{}) (ref *TagSvgMarker) {
	e.selfElement.Call(
		"addEventListener",
		"animationiteration",
		js.FuncOf(
