...
func main() {
	...
	s1 := factoryBrowser.NewTagSvg().ViewBox([]float64{0, 0, 400, 300}).XmlnsXLink("http://www.w3.org/1999/xlink").Append(
		factoryBrowser.NewTagSvgMetadata().Html(
			"<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n"+
				"xmlns:connect=\"http://www.w3.org/1999/08/29-svg-connections-in-RDF#\">\n"+
				"<rdf:Description about=\"#CableA\">\n"+
				"<connect:ends rdf:resource=\"#socket1\"/>\n"+
		...
		factoryBrowser.NewTagSvgTitle().Title("Network"),

		factoryBrowser.NewTagSvgDesc().Text("An example of a computer network based on a hub."),

		factoryBrowser.NewTagSvgStyle().Style("svg {\n"+
			"/* Default styles to be inherited */\n"+
			"fill: white;\n"+
			"stroke: black;\n"+
			"}\n"+
